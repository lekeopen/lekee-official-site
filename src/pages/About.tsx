    ...
    <div className="pb-16 min-h-screen bg-white">
      ...
      <div className="bg-blue-600 text-white py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold mb-6">关于乐可开源</h1>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            专注于 AI 与复杂系统工程实践的技术团队
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 -mt-10">
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12 border border-gray-100">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">团队简介</h2>
            <div className="text-gray-600 text-lg leading-relaxed space-y-6">
              <p>
                乐可开源是一支以 <strong>工程能力与长期交付</strong> 为核心的技术团队。
              ...
              <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-blue-600">
                <p className="font-semibold text-gray-800 mb-3">乐可开源并不追求“概念领先”，而更关注：</p>
              ...
              <p>
                在过去的项目实践中，乐可开源服务过不同行业与组织形态，参与过 <strong>复杂业务系统、内部管理平台、长期运维型项目</strong>，并逐步沉淀出一套以工程可靠性为核心的方法论。
              </p>
              <p className="font-bold text-center text-gray-900 pt-4 text-xl">
                乐可开源的目标很简单：成为客户在技术层面可以长期信任的合作伙伴。
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex p-8 bg-gray-50 rounded-xl border border-gray-100">
            ...
            <div>
              ...
              <div className="text-gray-600 space-y-4">
                <p>
                  乐可开源高度认同并积极拥抱开源文化。在项目中广泛使用成熟的开源技术栈，同时持续关注社区的发展与最佳实践。
                </p>
                <div>
                  <p className="font-semibold text-gray-800 mb-2 text-sm">对乐可开源而言，开源不是“省成本”，而是：</p>
                ...
                <p className="text-sm italic">
                  * 在合适的场景下，乐可开源也会将实践经验与工具以开源或技术分享的方式回馈社区。
                </p>
              </div>
            </div>
          </div>
          <div className="flex p-8 bg-gray-50 rounded-xl border border-gray-100">
            ...
            <div>
              ...
              <div className="text-gray-600 space-y-4">
                <p>
                  乐可开源坚信：优秀的软件来自稳定的工程体系，而不是个人英雄主义。
                </p>
                <div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 md:p-12">
          <div className="flex flex-col md:flex-row gap-12">
             <div className="md:w-1/3">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-4">乐可开源在做什么</h2>
                <p className="text-gray-600">
                  当前的工作重点主要集中在以下方向，部分方向已通过自研项目与实验性产品进行持续验证。
                </p>
             </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mt-20">
        <div className="bg-blue-50 rounded-xl p-8 md:p-12 border border-blue-100">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 mt-2">乐可开源更倾向于长期合作关系，而非一次性交付。</p>
          </div>
          ...
          <div className="text-center mt-10">
            <p className="text-lg font-semibold text-blue-800">
              如果你希望的是一个 “能一起把事情长期做好”的技术团队，乐可开源很乐意成为你的选择之一。
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="relative z-10">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              <p className="text-xl text-blue-100 font-light">
                未来，乐可开源将持续向 <span className="font-bold text-white">AI Native</span> 的方向演进
              </p>
              ...
              <p className="text-lg text-blue-200 mt-8 pt-6 border-t border-white/10">
                “乐可开源相信，真正有价值的 AI，不在于炫技，而在于是否能长期稳定地服务真实世界的问题。”
              </p>
            </div>
          </div>
        </div>
