  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 sm:py-20">
      ...
      <section className="mt-10">
        ...
        <p className="mt-4 leading-7 text-gray-700">当您主动提交产品反馈时，我们会将产品、版本、运行环境、问题类型、问题描述、称呼和联系方式作为结构化记录保存到乐知知识库，并通过支持邮箱发送处理通知，仅用于排查问题、回复咨询和改进产品。请勿提交学生名单、私人文件、密码或其他敏感信息。记录和邮件仅按处理问题、产品改进及履行必要记录义务所需的期限保留；如需查询或删除您提交的信息，请通过 contact@lekeopen.com 联系我们并提供反馈编号。</p>
      </section>
    </div>
  );
};
